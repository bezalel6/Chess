package ver32_negamax.model_classes.pieces;
...
import ver32_negamax.model_classes.Zobrist;
...
public abstract class Piece {
    ...
    public static final ConcurrentHashMap<Long, Boolean> isLegalMoveHashMap = new ConcurrentHashMap<>();
...
//        return isLegalMove2(move, board);
    ...
    boolean isLegalMove2(Move move, Board board) {
        boolean ret = true;
        ArrayList<Piece> piecesLookingAtMyKing = board.piecesLookingAt(board.getKing(pieceColor));
        if (piecesLookingAtMyKing.contains(this)) {
            for (Piece piece : piecesLookingAtMyKing) {
