...
import ver29_minimax_threading.Controller;
import ver29_minimax_threading.Location;
import ver29_minimax_threading.MyError;
import ver29_minimax_threading.Player;
import ver29_minimax_threading.model_classes.eval_classes.Eval;
import ver29_minimax_threading.model_classes.eval_classes.Evaluation;
import ver29_minimax_threading.model_classes.moves.*;
import ver29_minimax_threading.model_classes.pieces.*;
...
//        long pH = Zobrist.playerHash(player);
//        long tH = Zobrist.hashPieceType(type);
//        long lH = Zobrist.hash(from);
//        long bH = getBoardHash().getPiecesHash();
//        long hash = Zobrist.combineHashes(new long[]{pH, tH, lH, bH});
//        if (pieceMovesFromHashMap.containsKey(hash)) {
//            return pieceMovesFromHashMap.get(hash);
//        }
...
//        pieceMovesFromHashMap.put(hash, ret);
        return ret;
    }
