...
public abstract class Piece {
    ...
    public abstract ArrayList canMoveTo(Piece[][] pieces, boolean isCheckKing);
    ...
    public void add(ArrayList<ver3.types.Path> list, Location loc, Piece[][] pieces) {
        boolean bool = false;
    ...
    public void add(ArrayList<Path> list, int row, int col, Piece[][] pieces) {
        ...
        if(row>=0&&row<ROWS&&col>=0&&col<COLS) {
            ...
            if (piece != null && !isOnMyTeam(piece))
                bool = true;
            list.add(new ver3.types.Path(loc, bool));
        }
    }
    ...
    public void addAll(ArrayList<ver3.types.Path> addTo, ArrayList<Path> adding, Piece[][] pieces) {
