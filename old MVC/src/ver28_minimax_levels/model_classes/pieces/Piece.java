...
import ver28_minimax_levels.MyError;
import ver28_minimax_levels.Player;
...
public abstract class Piece {
    ...
    private static final ConcurrentHashMap<Long, ArrayList<ArrayList<Move>>> pseudoMovesGenerationHashMap = new ConcurrentHashMap<>();
...
//    }
    ...
    ArrayList<ArrayList<Move>> generatePseudoMoves(Board board) {
//        long hash = board.getBoardHash().getFullHash();
//        hash = Zobrist.combineHashes(hash, Zobrist.hash(pieceLoc));
//        if (pseudoMovesGenerationHashMap.containsKey(hash)) {
//            return pseudoMovesGenerationHashMap.get(hash);
//        }
        ArrayList<ArrayList<Move>> ret = generatePseudoMoves_(board);
//        pseudoMovesGenerationHashMap.put(hash, ret);
        return ret;
    }

    abstract ArrayList<ArrayList<Move>> generatePseudoMoves_(Board board);
