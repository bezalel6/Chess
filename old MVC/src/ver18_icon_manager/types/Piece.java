...
public abstract class Piece {
    ...
    private static boolean IS_LEGAL_GAME = true;
    int difference;
...
//        pieceLoc.setLoc(loc);
    ...
    public ArrayList<Move> canMoveTo(Board board) {
        ...
        if (IS_LEGAL_GAME) {
            for (ArrayList<Move> moves : generatePseudoMoves(board)) {
                checkLegal(ret, moves, board);
            }
        } else
            ret = getPseudoMovesList(board);
        return ret;
    }
    ...
    public ArrayList<Move> getPseudoMovesList(Board board) {
        ArrayList<Move> ret = new ArrayList();
        if (isEaten()) return ret;
        generatePseudoMoves(board).forEach(list -> ret.addAll(list));
        return ret;
    }
    ...
    public boolean equals(Object o) {
        ...
        Piece piece = (Piece) o;
        return eaten == piece.eaten && pieceColor == piece.pieceColor && pieceType == piece.pieceType && hasMoved == piece.hasMoved && pieceLoc.equals(piece.pieceLoc) && Objects.equals(annotation, piece.annotation);
    }
