...
public class MoveAnnotation {
    ...
    public void setCapture(int capturingPieceColor, int capturingPieceType) {
        assert checkValidPieceType(capturingPieceType);
        if (capturingPieceType != PAWN)
            capture += PIECES_FENS[capturingPieceColor][capturingPieceType];
    }
