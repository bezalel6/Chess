...
import static ver36_no_more_location.model_classes.pieces.PieceType.NUM_OF_PIECE_TYPES;
...
public enum Piece {
    ...
    private final static Piece[][] piecesMap = new Piece[Player.NUM_OF_PLAYERS][NUM_OF_PIECE_TYPES];
    ...
    private static String[][] createPiecesFens() {
        String[][] ret = new String[Player.NUM_OF_PLAYERS][NUM_OF_PIECE_TYPES];
