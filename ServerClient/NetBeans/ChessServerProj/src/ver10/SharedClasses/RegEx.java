...
public class RegEx implements Serializable {
    ...
    RegEx(@Language("RegExp") String regEx, String details, String... dontMatch) {
        this(regEx, details, true, dontMatch);
    }

    RegEx(@Language("RegExp") String regEx, String details, boolean useDontMatch, String... dontMatch) {
        this.regEx = regEx;
