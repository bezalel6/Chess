...
/**
 * Book - utility class for interacting with the opening book. an opening book
 * is a database containing lines of openings.
 *
...
public class Book {
    ...
    /**
     * looks for a game matching the current game inside the book games
     * database. if one is found, the next move is saved. after going through
     * all games in the database, if any matching game was found, a random move
     * from the saved moves is returned. if no matching game was found, null is
     * returned.
     *
     * @param model - current game position
     * @return a random move from every game found in the games' database, if
