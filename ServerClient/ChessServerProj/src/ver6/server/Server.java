...
import ver6.SharedClasses.SavedGames.CreatedGame;
...
import ver6.server.game.GameSession;
import ver6.server.players.Player;
import ver6.server.players.PlayerAI;
...
//        ShowOnScreen.showOnScreen(2, frmWin);
    ...
    public void syncedListUpdated(SyncedItems list) {
        ...
        SyncedItems finalList = list.clean();
...
//                        disconnectPlayer();
    ...
    private void handleClient(AppSocket playerSocket) throws MyErrors {
        ThrowingThread.ErrorHandler errorHandler = ThrowingThread.ErrorHandler.create();
        ThrowingThread.start(i -> {
            ClientMessagesHandler clientMessagesHandler = new ClientMessagesHandler(this, playerSocket);
            playerSocket.setHandlerAndStart(clientMessagesHandler, errorHandler);
            ...
            log("Client(" + playerSocket.getRemoteAddress() + ") Connected as " + player.loginInfo.getUsername());
    ...
    private void checkErrors() throws MyErrors {
