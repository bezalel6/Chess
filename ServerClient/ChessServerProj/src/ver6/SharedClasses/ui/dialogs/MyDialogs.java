package ver6.SharedClasses.ui.dialogs;
...
public class MyDialogs {
    ...
    public static void showInfo(Component parent, Component comp, String title, ImageIcon icon) {
        title = StrUtils.uppercaseFirstLetters(title);
    ...
    public static void showInfoMessage(Component parent, String message, String title, ImageIcon icon) {
        ...
        String finalTitle = title;
        new Thread(() -> {
            JOptionPane.showMessageDialog(parent, new MyLbl(finalMessage, FontManager.infoMessages), finalTitle, JOptionPane.INFORMATION_MESSAGE, icon);
        }).start();
    ...
    public static void showErrorMessage(Component parent, String error, String title, ImageIcon icon) {
        ...
        JOptionPane.showMessageDialog(parent, new MyLbl(error), title, JOptionPane.ERROR_MESSAGE, icon);
    }
