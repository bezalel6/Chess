package ver9.SharedClasses.networking;
...
public abstract class MessagesHandler {
    ...
    public void receivedMessage(Message message) {
            /*
            //askIlan should every message be processed in a new thread maybe a static executor to save on creation
            some messages need to be processed in a new thread to free blocking requests
                 ...
                 */
        if (!message.getMessageType().shouldBlock()) {
            new Thread(() -> {
