...
import ver10.SharedClasses.moves.CastlingRights;
import ver10.SharedClasses.moves.Direction;
import ver10.SharedClasses.moves.Move;
import ver10.SharedClasses.pieces.Piece;
import ver10.SharedClasses.pieces.PieceType;
import ver10.Model.Bitboard;
import ver10.Model.Model;
import ver10.Model.PiecesBBs;
    ...
    public static long enPassantHash(Model model) {
        ...
        if (enPassant != null && actualLoc != null) {
            ...
            if (piece != null && !piece.isOnMyTeam(currentPlayerColor))
                ret ^= zEnPassant[currentPlayerColor.asInt()][enPassant.getCol()];
        }
        return ret;
    }
