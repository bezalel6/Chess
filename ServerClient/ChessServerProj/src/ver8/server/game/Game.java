...
import ver8.SharedClasses.ui.GameView;
...
//        gameTime = new ServerGameTime(() -> timedOut(getCurrentPlayer().getPlayerColor()), TimeFormat.NORMAl);
    ...
    private GameStatus playTurn() {
        ...
        System.out.println("game time is " + gameTime);
        if (checkTimeOut()) {
