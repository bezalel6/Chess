...
import ver8.SharedClasses.SavedGames.CreatedGame;
import ver8.SharedClasses.SavedGames.GameInfo;
import ver8.SharedClasses.SavedGames.UnfinishedGame;
...
import ver8.SharedClasses.ui.windows.CloseConfirmationJFrame;
import ver8.server.DB.DB;
import ver8.server.game.Game;
import ver8.server.game.GameSession;
import ver8.server.players.Player;
import ver8.server.players.PlayerAI;
...
//            serverSocket.addClientSocket(playerSocket);
    ...
    public void gameSetup(Player player) throws MyErrors {
        ...
        switch (gameSettings.getGameType()) {
            ...
            case JOIN_EXISTING -> {
                GameInfo gameInfo = (GameInfo) gamePool.get(gameSettings.getJoiningToGameID());
                if (gameInfo == null) {
    ...
    public SyncedItems getResumableGames(Player playerNet) throws MyErrors {
