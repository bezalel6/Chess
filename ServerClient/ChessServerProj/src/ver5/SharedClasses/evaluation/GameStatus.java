package ver5.SharedClasses.evaluation;
...
public class GameStatus implements Serializable {
    ...
    private GameStatus(GameStatusType gameStatusType, PlayerColor winningPlayerColor, String gameStatusName) {
        ...
        this.gameStatusName = StrUtils.uppercaseFirstLetters(gameStatusName);
    }
    ...
    public static GameStatus playerDisconnected(PlayerColor winningPlayerColor) {
        return new GameStatus(GameStatusType.UNFINISHED, winningPlayerColor, "Other Player Disconnected");
    }
    ...
    public static GameStatus playerResigned(PlayerColor playerColor) {
        return new GameStatus(GameStatusType.WIN_OR_LOSS, playerColor.getOpponent(), "resignation");
    }
