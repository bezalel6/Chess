...
//        GameTime gameTime = new GameTime(TimeFormat.BULLET);
//        gameTime.startRunning(PlayerColor.WHITE);
//        Thread.sleep(1000);
//        gameTime.stopRunning(PlayerColor.WHITE);
//        System.out.println("b4 ser" + gameTime);
//        byte[] ser = SerializationUtils.serialize(gameTime);
//        gameTime = (GameTime) SerializationUtils.deserialize(ser);
//        System.out.println("after ser" + gameTime);
//
////        byte[] ser = SerializationUtils
//    }
