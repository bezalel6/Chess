...
import ver7.SharedClasses.moves.MovesList;
import ver7.SharedClasses.pieces.PieceType;
import ver7.model_classes.*;
...
public class Tests {
    ...
    public static void main(String[] args) throws IOException {
        ...
        AtomicBoolean keepCreating = new AtomicBoolean(true);
        new Thread(() -> {
            try {
...
//                 if(!socket1.getRemoteSocketAddress())

            } catch (IOException e) {
                e.printStackTrace();
            }
        }).start();
        while (keepCreating.get()) {
