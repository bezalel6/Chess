...
import ver8.view.Board.BoardButton;
import ver8.view.Board.BoardPanel;
import ver8.view.Dialog.SyncableList;
import ver8.view.Graph.Graph;
import ver8.view.List.Synced.OldSyncableList;
import ver8.view.List.Synced.SyncedJMenu;
import ver8.view.SidePanel.SidePanel;
...
//                toFront();
        ...
        OldSyncableList connectedUsers = new SyncedJMenu("connected", e -> {
        }, SyncedListType.CONNECTED_PLAYERS);
//        listsToRegister.add(connectedUsers);
        settingsMenu.add(connectedUsers.getComponentsList().navigationComp());

        OldSyncableList ongoingGames = new SyncedJMenu("games", e -> {
        }, SyncedListType.ONGOING_GAMES);
//        listsToRegister.add(ongoingGames);
        settingsMenu.add(ongoingGames.getComponentsList().navigationComp());
