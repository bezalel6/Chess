...
public class WinPnl extends JPanel implements ComponentsList.Container {
    ...
    private final ArrayList<VerifiedComponent> verifiedComponents;
    ...
    public WinPnl(int cols, Header header, boolean centerHeader) {
        ...
        this.cols = cols;
        this.header = header;
        this.verifiedComponents = new ArrayList<>();
...
//        return false;
        return verifiedComponents.stream().allMatch(VerifiedComponent::verify);
    }

    public void addList(ComponentsList comp) {
        addToVerifiedList(comp);
        add(comp.listContainer().container(), true, null);
    }

    public void addToVerifiedList(VerifiedComponent verified) {
        verifiedComponents.add(verified);
    }
    ...
    private void addIfVer(Navable navable) {
        if (navable instanceof VerifiedComponent verified) {
            addToVerifiedList(verified);
        }
    }
