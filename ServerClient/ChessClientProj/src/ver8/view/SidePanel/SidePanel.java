package ver8.view.SidePanel;

import ver8.SharedClasses.Callbacks.QuestionCallback;
...
public class SidePanel extends JPanel {
    ...
    public static class AskPlayer extends JPanel {
        ...
        private VoidCallback answerCallback(Question.Answer answer, QuestionCallback callback) {
            return () -> {
