...
import ver8.SharedClasses.board_setup.Square;
...
public class BoardPanel extends JPanel implements Iterable<BoardButton[]> {
    private final static Dimension btnDimension = new IconManager.Size(50);
    ...
    private IconManager.Size lastResize = new IconManager.Size(0);
    ...
    static void setAllSizes(JComponent comp, int w, int h) {
        IconManager.Size size = new IconManager.Size(w, h);
        comp.setSize(size);
...
//                    setMinimumSize(getPreferredSize());
    ...
    public void onResize() {
        ...
        lastResize = new IconManager.Size(getSize());
