package ver14.view.Dialog.Dialogs.OtherDialogs;
...
/**
 * represents a Custom dialog, mostly used to get input for {@link ver14.SharedClasses.DBActions.DBRequest.DBRequest}s. (like getting a date ranges for a games in range request).
 *
...
public class CustomDialog extends Dialog implements CancelOk {
    ...
    /**
     * Instantiates a new Custom dialog with fields to satisfy the given {@code args}.
     *
