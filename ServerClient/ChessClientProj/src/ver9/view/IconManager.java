...
import ver9.SharedClasses.DBActions.Graphable.GraphElementType;
...
import ver9.view.Board.BoardOverlay;
...
public class IconManager {
    ...
    public static final ImageIcon settingsGif;
    ...
    static {
        ...
        settingsIcon = loadGif("settingsIcon", SECONDARY_COMP_SIZE);
        settingsGif = loadGif("settingsGif", SECONDARY_COMP_SIZE);
...
//        ImageIcon icon = new ImageIcon(img.getDescription());
...
//        return new ImageIcon(icon.getImage().getScaledInstance(size.width, size.height, Image.SCALE_SMOOTH), img.getDescription());
    }
    ...
    public static class Size extends Dimension {
        ...
        public static Size minSize(Dimension size) {
