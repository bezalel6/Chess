...
import ver10.view.Dialog.Dialogs.ChangePassword.ChangePassword;
...
//    }
    ...
    public void changePassword() {
        ChangePassword changePassword = showDialog(new ChangePassword(clientSocket, DialogProperties.example, view.getWin(), loginInfo.getPassword()));
        String pw = changePassword.getPassword();
        if (pw != null) {
            request(RequestBuilder.changePassword(), null, pw);
        }

    }

    public void request(RequestBuilder builder, Object... args) {
        if (args == null) {
            return;
        }
