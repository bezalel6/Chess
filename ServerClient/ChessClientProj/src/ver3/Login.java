...
public class Login {
    ...
    public static LoginInfo showLoginDialog(String errMsg) {
        // הצגת תמונת כניסה
        ...
        JOptionPane optionPane = new JOptionPane(inputFields, -1, 1, null, new Object[]{LOGIN, GUEST, CANCEL_AND_EXIT}, LOGIN);
