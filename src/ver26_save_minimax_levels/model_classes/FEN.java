...
import ver26_save_minimax_levels.model_classes.pieces.Piece.Player;
...
public class FEN {
    ...
    public void loadFEN() {
        assert fen.matches("\\s*([rnbqkpRNBQKP1-8]+\\/){7}([rnbqkpRNBQKP1-8]+)\\s[bw-]\\s(([a-hkqA-HKQ]{1,4})|(-))\\s(([a-h][36])|(-))\\s\\d+\\s\\d+\\s*");
