...
import static ver28_minimax_levels.model_classes.pieces.Piece.NUM_OF_PIECE_TYPES;
import static ver28_minimax_levels.model_classes.pieces.Piece.NUM_OF_PLAYERS;
...
//    }
    ...
    public static long player2MoveHash(Board board) {
        return zPlayers[board.getCurrentPlayer()];
    }
    ...
    public static long hash(Location loc, int player) {
        return hash(loc) + zPlayers[player];
    }
