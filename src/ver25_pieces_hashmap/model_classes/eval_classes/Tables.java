package ver25_pieces_hashmap.model_classes.eval_classes;

import ver25_pieces_hashmap.model_classes.eval_classes.Eval.GamePhase;
...
public class Tables {
    ...
    public static PieceTable getPieceTable(int pieceType) {
    ...
    static class PieceTable {
        ...
        public PieceTable(int[][] middleGame, int[][] endGame) {
            tables = new int[2][][][];
            tables[GamePhase.MIDDLE_GAME] = init(middleGame);
            tables[GamePhase.ENDGAME] = init(endGame);
        }
        ...
        public double convertFromCentiPawns(int phase, int player, Location loc) {
            double ret = tables[phase][player][loc.getRow()][loc.getCol()];
            ret /= 100;
            return ret;
        }
    }
