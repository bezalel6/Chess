...
//                            assert piece instanceof Rook;
    ...
    public void setCapturing(Piece piece, Board board) {
        ...
        this.capturingPieceIndex = piece.getPieceIndex();
        assert capturingPieceIndex != -1;
