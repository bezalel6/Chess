package ver29_minimax_threading.view_classes;
...
import ver29_minimax_threading.view_classes.dialogs_classes.Message;
...
public class View implements Iterable<BoardButton[]> {
    ...
    public View(int boardSize, Controller controller, int boardOrientation) {
        ...
        this.isBoardFlipped = boardOrientation != Player.WHITE;
        createGui();
    }
...
//        showOnScreen(1, win);
    ...
    private void resetMat() {
        ...
        for (int i = 0; i < ROWS; i++) {
            for (int j = 0; j < COLS; j++) {
                Location btnLoc = new Location(i, j, boardOrientation == Player.WHITE);
