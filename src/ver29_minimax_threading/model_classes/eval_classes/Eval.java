package ver29_minimax_threading.model_classes.eval_classes;
...
import ver29_minimax_threading.model_classes.GameStatus;
import ver29_minimax_threading.model_classes.Square;
import ver29_minimax_threading.model_classes.moves.Move;
import ver29_minimax_threading.model_classes.pieces.King;
...
//        int player = Player.getOpponent(currentPlayer);
        if (board.generateAllMoves(currentPlayer).isEmpty()) {
