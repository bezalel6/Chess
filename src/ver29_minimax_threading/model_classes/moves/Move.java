...
import ver29_minimax_threading.model_classes.BoardHash;
import ver29_minimax_threading.model_classes.CastlingAbility;
...
import ver29_minimax_threading.model_classes.pieces.Rook;
...
public class Move implements Comparable<Move> {
    ...
    public Move(Location movingFrom, Location movingTo, int movingPlayer, int movingPieceType, int capturingPieceType, Board board) {
        assert Piece.isValidPieceType(movingPieceType);
        assert capturingPieceType == NOT_CAPTURING || capturingPieceType == TEMP_CAPTURING || Piece.isValidPieceType(capturingPieceType);
