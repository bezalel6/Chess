...
import static ver29_minimax_threading.model_classes.moves.MoveAnnotation.CHECK_ANN;
import static ver29_minimax_threading.model_classes.moves.MoveAnnotation.GAME_STATUS_ANNOTATIONS;

public class GameStatus {
    public static final int NUM_OF_GAME_OVERS = 7;
...
//    public static final int GAME_GOES_ON = 3;
    ...
    private static GameStatusType[] initializeStatusTypes() {
        ...
        ret[CHECKMATE] = GameStatusType.WIN_OR_LOSS;
