...
import ver14_pieceLocation.moves.PromotionMove;
...
public class Controller {
    ...
    public void startNewGame() {
        ...
        numOfMoves = model.getBoard().getFullMoveCounter();
    ...
    public void boardButtonPressed(Location loc) {
        ...
        if (isFirstClick) {
            ...
            if (move != null && currentPiece != null && !currentPiece.getLoc().getLoc().equals(loc)) {
    ...
    private void gameOver(BoardEval gameStatus) {
        ...
        } else if (gameStatus.getGameStatus() == GameStatus.FIFTY_MOVES) {
            view.tieByFiftyMoves();
        }
    }
