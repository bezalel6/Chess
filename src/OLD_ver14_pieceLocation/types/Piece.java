...
public abstract class Piece {
    ...
    public Piece(int worth, Location loc, Player pieceColor, types pieceType, String annotation, boolean hasMoved) {
        ...
        pieceLocation = new PieceLocation(loc);
    }
    ...
    public PieceLocation getLoc() {
        return pieceLocation;
    }

    public void setLoc(Location loc) {
        pieceLocation.setLoc(loc);
    }
    ...
    public Move add(ArrayList<Move> list, int row, int col, Board board) {
        ...
        if (isInBounds(loc)) {
            ...
            Move newMove = new Move(getLoc(), loc, isCapturing, board);
            if (this instanceof Pawn && Math.abs(row - getLoc().getLoc().getRow()) == 2) {
    ...
    public boolean equals(Object o) {
        ...
        Piece piece = (Piece) o;
        return worth == piece.worth && pieceColor == piece.pieceColor && pieceType == piece.pieceType && hasMoved == piece.hasMoved && getLoc().equals(piece.getLoc()) && Objects.equals(annotation, piece.annotation);
    }
