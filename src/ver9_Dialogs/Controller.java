...
public class Controller {
    ...
    public void startNewGame() {
        ...
        int startingPosition = positionsDialog.run(objects);
    ...
    private ArrayList<DialogObject> getPromotionObjects(colors color) {
        ...
        if (color == colors.WHITE) {
            ret.add(new DialogObject(view.wn, Knight.worth));
            ret.add(new DialogObject(view.wb, Bishop.worth));
            ret.add(new DialogObject(view.wq, Queen.worth));
            ret.add(new DialogObject(view.wr, Rook.worth));
        } else {
            ret.add(new DialogObject(view.bn, Knight.worth));
            ret.add(new DialogObject(view.bb, Bishop.worth));
            ret.add(new DialogObject(view.bq, Queen.worth));
            ret.add(new DialogObject(view.br, Rook.worth));
        }
        return ret;
    }
