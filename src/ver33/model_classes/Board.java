...
import ver33.model_classes.moves.*;
import ver33.model_classes.pieces.*;
...
public class Board implements Iterable<Square[]> {
    ...
    private HashMap<Long, ArrayList<Move>> uniqueMoveStrsCheck;
...
//        System.out.println(stackTraceElements[2]);
    ...
    public boolean anyLegalMove() {
        ...
        if (movesGenerationHashMap.containsKey(hash)) {
            return !movesGenerationHashMap.get(hash).isEmpty();
        }
